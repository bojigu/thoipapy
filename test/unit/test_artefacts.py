...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            ...
            (DATABASE, ACC),
            "features/coevolution/crystal/1xioA4.surr20.gaps5.freecontact_parsed.csv",
        ),
        (
            "combined_features_csv",
            (DATABASE, ACC),
            "features/combined/crystal/1xioA4.surr20.gaps5.combined_features.csv",
        ),
        ...
        (
            "feat_imp_MDI_before_feature_seln_csv",
            (),
            "results/set08/train_data/01_feat_imp_MDI_before_feature_seln.csv",
        ),
        (
            "tuned_ensemble_parameters_before_feature_seln_csv",
            (),
            "results/set08/train_data/01_tuned_ensemble_parameters_before_feature_seln.csv",
        ),
        ...
        (
            ...
            (),
            "results/set08/train_data/03_train_data_after_first_feature_seln.csv",
        ),
...
def test_suffix_follows_the_settings_rather_than_being_hardcoded():
    ...
    non_default = ArtefactPaths(
        data_dir=DATA_DIR,
        setname=SETNAME,
        num_of_sur_residues=30,
        max_n_gaps_in_TMD_subject_seq=2,
    )
