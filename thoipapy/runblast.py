...
#dfset = pd.read_excel('TrainData.xlsx')
#for filename in glob.glob(os.path.join("C:\\Users\\ZENGBO11\\Desktop\\Xiao\\Mark\\Proteins\\XiaoProtein","*.fasta")):
for filename in glob.glob(os.path.join("/scratch2/zeng/pythonscript","*.fasta")):
