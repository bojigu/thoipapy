...
def tune_ensemble_parameters(s, logging):
    ...
    A broader quick search for parameters is first made with RandomizedSearchCV.
        ...
        Use these to tweak the range for the GridSearch parameters.
    ...
    if True in df_data.columns.str.contains("Unnamed").tolist():
        raise ValueError(f"unnamed column found when reading {train_data_filtered}")
