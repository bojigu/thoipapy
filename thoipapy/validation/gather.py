"""Gather validation outputs into the summary spreadsheet.
...
def gather_validation_data_for_figs(paths: ArtefactPaths, df_set, logging):
    ...
    all_res_precision_recall_data_csv: Path = paths.crossvalidation_dir / f"precision_recall/{paths.setname}_all_res_precision_recall_data.csv"
    all_res_ROC_data_csv: Union[Path, str] = paths.crossvalidation_dir / f"ROC/{paths.setname}_all_res_ROC_data.csv"
    ...
    # outputs
    validation_summary_xlsx: Union[Path, str] = paths.results_dir / f"validation_summary/validation_summary.xlsx"
    ...
    for subset in subsets:
        ...
        precision_recall_data_csv: Union[Path, str] = paths.crossvalidation_dir / f"precision_recall/{paths.setname}_all_res_precision_recall_data_{subset}_subset.csv"
        ROC_data_csv: Union[Path, str] = paths.crossvalidation_dir / f"ROC/{paths.setname}_all_res_ROC_data_{subset}_subset.csv"
        ...
        crossvalidation_summary_subset_xlsx: Union[Path, str] = paths.results_dir / f"validation_summary/validation_summary_subset_{subset}.xlsx"
...
def create_df_with_all_predictions_for_all_residues_in_set(paths: ArtefactPaths, df_set_nonred, pred_all_res_csv, logging):
