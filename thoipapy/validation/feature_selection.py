...
def drop_cols_not_used_in_ML(logging, df_data, i=0):
    ...
    df_data : pd.DataFrame
        ...
        columns :
    """
    # read the feature eligibility table
    ...
    unused_features_in_model_features_csv = set(features_df.index) - set(df_data.columns)
    features_missing_from_model_features_csv = set(df_data.columns) - set(features_df.index)
